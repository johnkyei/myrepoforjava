pipeline {
  ...
  stages {
    ...
    stage ('Nexus Upload') {
      ...
      nexusVersion: 'nexus3',
      protocol: 'http',
      nexusUrl: ' ec2-34-204-188-152.compute-1.amazonaws.com',
      groupId: 'myGroupId',
    ...
    stage ('DEV Deploy') {
      ...
      deploy adapters: [tomcat9(credentialsId: '5490977e-5d40-45a1-8da4-fd98381fae91', path: '', url: 'http:// ec2-35-175-134-69.compute-1.amazonaws.com')], contextPath: null, war: '**/*.war'
      }
    }
